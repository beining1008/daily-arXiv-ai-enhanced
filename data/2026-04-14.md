...
### [1] [OccuBench: Evaluating AI Agents on Real-World Professional Tasks via Language World Models](https://arxiv.org/abs/2604.10866)
...
### [2] [Mem$^2$Evolve: Towards Self-Evolving Agents via Co-Evolutionary Capability Expansion and Experience Distillation](https://arxiv.org/abs/2604.10923)
...
### [3] [HiEdit: Lifelong Model Editing with Hierarchical Reinforcement Learning](https://arxiv.org/abs/2604.11214)
...
### [4] [Self-Evolving LLM Memory Extraction Across Heterogeneous Tasks](https://arxiv.org/abs/2604.11610)
...
### [5] [CLSGen: A Dual-Head Fine-Tuning Framework for Joint Probabilistic Classification and Verbalized Explanation](https://arxiv.org/abs/2604.11801)
...
### [6] [DIB-OD: Preserving the Invariant Core for Robust Heterogeneous Graph Adaptation via Decoupled Information Bottleneck and Online Distillation](https://arxiv.org/abs/2604.10882)
...
### [7] [A Faster Path to Continual Learning](https://arxiv.org/abs/2604.11064)
...
### [8] [Quantum-Gated Task-interaction Knowledge Distillation for Pre-trained Model-based Class-Incremental Learning](https://arxiv.org/abs/2604.11112)
...
### [9] [AHC: Meta-Learned Adaptive Compression for Continual Object Detection on Memory-Constrained Microcontrollers](https://arxiv.org/abs/2604.09576)
*Bibin Wilson*
...
### [10] [OOWM: Structuring Embodied Reasoning and Planning via Object-Oriented Programmatic World Modeling](https://arxiv.org/abs/2604.09580)
...
### [11] [Persistent Identity in AI Agents: A Multi-Anchor Architecture for Resilient Memory and Continuity](https://arxiv.org/abs/2604.09588)
*Prahlad G. Menon*
...
### [12] [Controllable and Verifiable Tool-Use Data Synthesis for Agentic Reinforcement Learning](https://arxiv.org/abs/2604.09813)
...
### [13] [EE-MCP: Self-Evolving MCP-GUI Agents via Automated Environment Generation and Experience Learning](https://arxiv.org/abs/2604.09815)
...
### [14] [Zero-shot World Models Are Developmentally Efficient Learners](https://arxiv.org/abs/2604.10333)
...
### [15] [Failure Ontology: A Lifelong Learning Framework for Blind Spot Detection and Resilience Design](https://arxiv.org/abs/2604.10549)
...
### [16] [Do LLMs Build Spatial World Models? Evidence from Grid-World Maze Tasks](https://arxiv.org/abs/2604.10690)
...
### [17] [From Topology to Trajectory: LLM-Driven World Models For Supply Chain Resilience](https://arxiv.org/abs/2604.11041)
*Jia Luo*
